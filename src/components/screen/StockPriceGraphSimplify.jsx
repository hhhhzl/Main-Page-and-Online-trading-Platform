...
import {
  ...
  removeWatchList,
  updateWatchList,
} from "redux/reducers/WatchList/WatchListReducer";
...
function StockPriceGraphSimplify({
  ...
  const handleClose1 = () => {
    setshowAddselfselected(false);
    // window.location.reload(false)
  };
  const handleClose2 = () => {
    setshowdeleteselfselected(false);
    // window.location.reload(false)
  };
            ...
            <Card style={{ width: widthratio, borderColor: "white" }}>
              ...
              >
                <div style={{ width: "max-content" }}>
                  ...
                  >
                    ￥{stockdata ? fmoney(stockdata?.最新价, 2) : <Spinner animation="border"></Spinner>}
                  </div>
                ...
                >
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 0 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                  ...
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 1 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                    variant="outline-primary"
                  ...
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 2 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                    variant="outline-primary"
                  ...
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 3 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                    variant="outline-primary"
                  ...
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 4 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                    variant="outline-primary"
                  ...
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 5 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                    variant="outline-primary"
                  ...
                  <Button
                    style={{
                      ...
                      padding: "0px",
                      color:
                        id == 6 ? (updown ? "#42E083" : "#FF3541") : "#2A2B30",
                      lineHeight: "28px",
                      letterSpacing: "1px",
                    }}
                    variant="outline-primary"
