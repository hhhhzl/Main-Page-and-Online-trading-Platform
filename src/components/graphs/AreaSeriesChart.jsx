...
class AreaSerieschart extends React.Component {
    constructor(props) {
		super(props);
      ...
      >
        ...
        <defs>
						<linearGradient id="MyGradient" x1="0" y1="100%" x2="0" y2="0%">
							...
							<stop offset="50%" stopColor="#42E083" stopOpacity={0.1} />
							<stop offset="100%"  stopColor="#42E083 " stopOpacity={0.16} />
						</linearGradient>
		</defs>
...
AreaSerieschart.defaultProps = {
  type: "svg"
};

const AreaSeriesChart = fitWidth(AreaSerieschart);
