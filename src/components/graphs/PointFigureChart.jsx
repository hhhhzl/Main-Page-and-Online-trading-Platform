...
import { ema, macd, sma, bollingerBand, pointAndFigure } from "react-stockcharts/lib/indicator";
...
import PointAndFigureSeries from "react-stockcharts/lib/series/PointAndFigureSeries";
...
class PointFigureChart extends React.Component {
	constructor(props) {
		super(props);
	...
	render() {
		...
		const calculatedtest = macdCalculator(dataprepareMa(pAndF(SampleData),emafuncreal))
...
PointFigureChart.defaultProps = {
	type: "svg",
};

const PointFigurechart = fitWidth(PointFigureChart);
