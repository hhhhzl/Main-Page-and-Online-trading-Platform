    ...
    return (
      ...
      >
        <Chart id={0} yExtents={(d) => d.open}>
          ...
          stroke ={{ top: data[0].open > data[data.length -90].open? '#42E083':"#2B8CFF" , bottom: data[0].open > data[data.length -90].open? '#42E083':"#2B8CFF" }}
          fill ={{ top: data[0].open > data[data.length -90].open? '#42E083':"#2B8CFF" , bottom: data[0].open > data[data.length -90].open? '#42E083':"#2B8CFF" }}
          interpolation={curveMonotoneX}
