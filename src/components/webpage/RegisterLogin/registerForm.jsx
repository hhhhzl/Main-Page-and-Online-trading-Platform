...
export default function RegisterForm(props) {
  ...
  useEffect(() => {
    if (submit) {
      setUserState({
        ...userState,
        ...{ institution: linkedSchool.value },
        ...{ region: linkedArea.value },
      });
      setsubmit(false);
      console.log(userState);
    }
      ...
      {page == 1 ? (
        <>
          ...
          >
            ...
            <div style={{ marginBottom: "20px", marginTop: "60px" }}>
              ...
              >
                <span
                  className="publish-upload-file-text"
                  style={{ color: "#1442ED", marginLeft: "0px" }}
                >
                  上传头像
                </span>
                <input
            ...
            >
              ...
              <Form.Group className="loadingusername">
                <Form.Label column>用户名</Form.Label>
              ...
              <Form.Group className="mb-3">
                <Form.Label column>密码</Form.Label>
                <Form.Control
                  className="loadinglogin"
                  required
                  type="password"
              ...
              <Form.Group className="loadingusername">
                <Form.Label column>确认密码</Form.Label>
                <Form.Control
                  className="loadinglogin"
                  required
                  type="password"
              ...
              <Form.Group className="loadingusername">
                <Form.Label>微信号（便于邀请您进入赛事微信群）</Form.Label>
              ...
              <Form.Group className="loadingusername">
                <Form.Label column>真实姓名</Form.Label>
        ...
        <>
          ...
          >
            ...
            >
              <Form.Group className="loadingusername">
                <Form.Label column>学历</Form.Label>
              ...
              >
                {(props) => (
                  <>
                    <Form.Group className="loadingusername">
                      <Form.Label column>所在国家/地区</Form.Label>
              ...
              <Form.Group className="loadingusername">
                <Form.Label column>专业</Form.Label>
                      ...
                      <div style={{ display: "flex", alignItems: "center" }}>
                        ...
                        <Image
                          ...
                          style={{
                            ...
                            height: "22px",
                            display:
                              experienceList.length == 1 ? "none" : "block",
                          }}
                        />
                      </div>
                    </Form.Group>
