      ...
      <div>
              ...
              >
                <div className="finance-date-div-first">
                  ...
                  <div className="finance-title-imgage">
                    ...
                    <div className="finance-title-imgage-div-first">
                      热点话题发布
                    </div>
                ...
                <div
                  className="finance-date-div-first"
                  style={{
        ...
        <div style={{ background: "#F5F6F8" }}>
          ...
          >
            ...
            <div>
              <div className="finance-title-two" style={{ paddingTop: "80px" }}>
                模范经纪人
              </div>
              <div
            ...
            <div
              className={width > 766 ? "tips-end" : "tips-center"}
