              ...
              >
                <div style={{ width: "72px", height: "72px" }}>
                  {hovercreate ? (
                    <>
                      <Image
                        src={"/homeCutout/Group 1095@2x.png"}
                        style={{
                          position: "relative",
                          width: "100%",
                          height: "100%",
                    ...
                    <>
                      <Image
                        src={"/homeCutout/Group 1095-black@2x.png"}
                        style={{
                          position: "relative",
                          width: "100%",
                          height: "100%",
              ...
              >
                <div
                  style={{
                    ...
                    fontFamily: "Microsoft YaHei U-Bold, Microsoft YaHei UI",
                    fontWeight: "bold",
                    color: hovercreate ? "#FFFFFF" : "#2A2B30",
                    lineHeight: "36px",
                    letterSpacing: "1px",
                  }}
                >
              ...
              >
                <div style={{ width: "72px", height: "72px" }}>
                  {hoverjoin ? (
                    <>
                      <Image
                        src={"/homeCutout/Group 1098-white@2x.png"}
                        style={{
                          position: "relative",
                          width: "100%",
                          height: "100%",
                    ...
                    <>
                      <Image
                        src={"/homeCutout/Group 1096@2x.png"}
                        style={{
                          position: "relative",
                          width: "100%",
                          height: "100%",
